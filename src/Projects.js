...
function Projects() {
    return (
        ...
        <div className='projects-grid-item'><h4><a href='https://github.com/TomNPython/ToDoImproved'><p>To Do List</p></a></h4>
        <p>A basic ToDo list app, with options to add and remove items.</p>
        <p>Made using: <ul><li>ReactJS</li></ul>
        </p></div>
        <div className='projects-grid-item'><h4><a href='https://github.com/TomNPython/IPAddressShower'><p>IP Address Revealer</p> </a></h4>
        ...
        <div className='projects-grid-item'><h4><a href='https://github.com/TomNPython/MarkdownPreviewer'><p>Markdown Previewer</p></a></h4>
        ...
        <div className='projects-grid-item'><h4><a href='https://github.com/TomNPython/QuoteGen'><p>Author Quote Generator</p></a></h4>
        ...
        <div className='projects-grid-item'><h4><a href='https://github.com/TomNPython/JavaScriptCalculator'><p>Calculator</p></a></h4>
        <p>A basic calculator, allowing the user to perform basic maths.</p>
        <p>Made using: <ul><li>Pure JavaScript</li></ul>
        </p></div>
        <div className='projects-grid-item'><h4><a href='https://github.com/TomNPython/Pomodoro-Clock'><p>Pomodoro Clock</p></a></h4>
